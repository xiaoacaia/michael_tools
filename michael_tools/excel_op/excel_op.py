...
# 调整 Excel 工作表的列宽
def adjust_column_width(worksheet, df, width_multiplier):
...
# 创建新的 Excel工作表，并写入数据
def create_sheet_to_excel(workbook, sheet_name, df, width_multiplier=1.7):
    # 如果工作表已存在，删除它
    ...
    # 调整列宽
    adjust_column_width(worksheet, df, width_multiplier)
